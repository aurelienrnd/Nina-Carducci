  ...
  $.fn.mauGallery.methods = {
    ...
    */
    prevImage() {
      ...
      // set next a l'image suivante de l'index i ou a la derniere image de la collection 
      // et j'attribue l'attribut src de next a .lightboxImage
    ...
    */
    nextImage() {
      ...
      $(imagesCollection).each(function(i) {
        if ($(activeImage).attr("src") === $(this).attr("src")) {
          index = i+1; //AJOUT DE +1 POUR CORRIGER LE PROBLEME D'AFFICHAGE de L'IMAGE SUIVANTE  
        }
      });

      // set next a l'image suivante de l'index i ou a la premiere image de la collection 
      // et j'attribue l'attribut src de next a .lightboxImage
